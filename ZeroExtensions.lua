...
function ZeroExtensions.Login(mail,pass)
	...
	print(1)
	local request = ZeroExtensions.GetRequest("http://www.zerobywzz.com/member.php?mod=logging&action=login&infloat=yes&frommessage&inajax=1&ajaxtarget=messagelogin");
...
function ZeroExtensions.DoLogin(mail,pass,loginHashResult,loginFormhash)
	...
	mangaTextureRequest:AddField("referer","http://www.zerobywzz.com/home.php?mod=spacecp&ac=usergroup")
	...
	mangaTextureRequest:SetHeader("Host","www.zerobywzz.com");
	mangaTextureRequest:SetHeader("Origin","www.zerobywzz.com");

	mangaTextureRequest:SetHeader("referer", "http://www.zerobywzz.com/home.php?mod=spacecp&ac=usergroup");
	local url = string.format("http://www.zerobywzz.com/member.php?mod=logging&action=login&loginsubmit=yes&frommessage&loginhash=%s&inajax=1",loginHashResult)
	local uri = mUri(url);
	print(url)
	mangaTextureRequest.Uri = uri;
	local jsonTable = {
		formhash = loginFormhash,
		referer= "http://www.zerobywzz.com/home.php?mod=spacecp&ac=usergroup",
		loginfield =  "username",
		username = mail ,
		password = pass ,
		questionid=0,
...
function ZeroExtensions.RequestMangaDetail(url)
	...
	print(string.format("http://www.zerobywzz.com%s",url))
	local request = ZeroExtensions.GetRequest(string.format("http://www.zerobywzz.com%s",url));
	request.Callback=callBack;
	request:Send();
end
...
function ZeroExtensions.RequestSearchManga(query)
	...
	local request = ZeroExtensions.GetRequest(string.format("http://www.zerobywzz.com/plugin.php?id=jameson_manhua&a=search&c=index&keyword=%s&page=%s",query,1));
	request.Callback=callBack;
	request:Send();
end
...
function ZeroExtensions.GetGenreTable()
	return {
		First = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&&page=%s",
		卖肉 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=1&page=%s",
		日常 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=32&page=%s",
		后宫 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=6&page=%s",
		搞笑 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=13&page=%s",
		爱情 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=31&page=%s",
		冒险 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=22&page=%s",
		奇幻 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=23&page=%s",
		战斗 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=26&page=%s",
		体育 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=29&page=%s",
		机战 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=34&page=%s",
		职业 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=35&page=%s",
		汉化组跟上，不再更新 = "http://www.zerobywzz.com/plugin.php?id=jameson_manhua&c=index&a=ku&category_id=36&page=%s",
	};
end
